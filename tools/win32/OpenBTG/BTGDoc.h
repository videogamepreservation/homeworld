...
public:
    ...
    unsigned long btglNumSelected(void);
    unsigned long btglNumExisting(void);
    ...
    BTGLight* btglCheckExisting(CPoint point);
    ...
    void btglSelect(CPoint point);
    void btglSelect(BTGLight* pLight);
    void btglUnSelect(BTGLight* pLight);

	void btgvClearSelected(void);
	void btgsClearSelected(void);
	void btgpClearSelected(void);
    void btglClearSelected(void);
	...
	void btgvUpdateBackgroundColor(signed long red, signed long green, signed long blue, signed long alpha);
	...
	enum btgDocModes
	{
        ...
        btgDocMode_EditBTGLights,       // Edit the light list.
	...
	signed long mBGRed, mBGGreen, mBGBlue, mBGAlpha;
