/*=============================================================================
    Name    : CommandNetworkSimple.h
    Purpose : Only contains basic elements of CommandNetwork.h

    Created 4/19/1999 by gshaw
    Copyright Relic Entertainment, Inc.  All rights reserved.
=============================================================================*/

#ifndef ___COMMAND_NETWORK_SIMPLE_H
#define ___COMMNAD_NETWORK_SIMPLE_H
...
typedef struct
{
    ...
    real32 blobcheck;   // blob checksum
} NetSyncChecksums;
#endif
